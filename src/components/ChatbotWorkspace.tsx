...
import { DynamicAttentionBar } from './DynamicAttentionBar';
import { EmotionalFeedbackPopup } from './EmotionalFeedbackPopup';
import { MotivationalPopup } from './MotivationalPopup';
import { TimerButton } from './TimerButton';
import { TimerDropdown } from './TimerDropdown';
import { PomodoroControlPanel } from './PomodoroControlPanel';
import { BACKEND_ROUTES, buildBackendUrl } from '../config/backend';
import { chatWithAITutor, fetchFlashcardsFromChat, fetchQuizFromChat, getOrCreateTutorThreadId } from '../utils/aiClient';
